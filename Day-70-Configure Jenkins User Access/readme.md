...
2. Create a jenkins user named john with the password Rc5C9EyvbU. Their full name should match John.
...
1. Refer the given below link for visual representation :-

    `https://github.com/imShakil/100-Days-Of-DevOps-Challenge-KodeKloud/blob/main/days/070.md`