...
1. Create a 5 file for the configration and put the content in each file

  ![file 1](./manifest%20files/namespace.yml)
  ![file 2](./manifest%20files/deployment.yml)
  ![file 3](./manifest%20files/deployment2.yml)
  ![file 4](./manifest%20files/service.yml)
  ![file 5](./manifest%20files/service2.yml)

2. Now apply the resources
...
3. Verify the resources 
  ...
  ``` bash 
      kubectl get all -o wide -n iron-namespace-datacenter
  ```
