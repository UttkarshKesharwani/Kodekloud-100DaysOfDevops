...
now tell me this one only and forget all the above question and one more thing give mew in detail in every step as this is kodekloud task , and give me in detail


# Solution :

1. Do step by step , watch any tutorial or ask the chatgpt , how to do it.
